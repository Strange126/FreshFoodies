		...
		<div class="container-fluid w-100">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link fs-4 active" href="<%=request.getContextPath()%>/login.jsp">Login</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="row border border-dark rounded m-3">
			...
			<div class="col align-self-center border border-dark rounded m-5">
				<div style="text-align: justify;" class="m-3">
					<h1>Sign Up</h1>
					<label>Please Enter your Email and Password to Sign Up</label>
				</div>
				<form action="SignUpServlet" method="post">
					<div class="container">
						<div class="row m-3">
							<div class="col-sm col-sm-offset-3">
								<label for="SignUpUsername">Username:</label> <input
									class="form-control" name="SignUpUsername" id="SignUpUsername"
						...
						<div class="row m-3">
							<div class="col-sm col-sm-offset-3">
								<label for="SignUpPassword">Password:</label> <input
									class="form-control" name="SignUpPassword" id="SignUpPassword"
									placeholder="**********">
							</div>
						</div>
						<div class="row m-3">
								...
								<div class="col-sm-6 col-sm-offset-3 m-3">
									<p>
										<button class="btn btn-primary btn-lg" type="submit"
											value="Call Servlet">Sign Up</button>
									</p>
								</div>
							</div>
						</div>
